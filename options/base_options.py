...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--netD', type=str, default='basic', choices=['cvt', 'convtrans', 'transdis', 'spatch', 'basic', 'n_layers', 'pixel', 'patch', 'tilestylegan2', 'stylegan2'], help='specify discriminator architecture. The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG', type=str, default='resnet_pre', choices=['resnet_pre', 'transtyle', 'resnet_9blocks', 'resnet_6blocks', 'unet_256', 'unet_128', 'stylegan2', 'smallstylegan2', 'resnet_cat'], help='specify generator architecture')
        ...
        parser.add_argument('--val_batch_size', type=int, default=10, help='validation input batch size')
